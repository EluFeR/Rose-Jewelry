                        ...
                        <div class="register_1 clearfix">
                            ...
                            <div class="col-sm-6 space_left">
                                ...
                                <div>
                                    ...
                                    <asp:GridView ViewStateMode="Enabled" CssClass="table" ID="GridViewCategory" runat="server" AutoGenerateColumns="False" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:Button CssClass="btn btn-primary" ID="btnEnable" runat="server" Text="Edit" CommandName="Edit" CommandArgument='<%# Eval("CategoryID") %>' />
                                                    <asp:Button CssClass="btn btn-danger" ID="btnDisable" runat="server" Text="Delete" CommandName="Delete" CommandArgument='<%# Eval("CategoryID") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
